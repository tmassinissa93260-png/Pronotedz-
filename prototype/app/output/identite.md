# Verrouillage d'identite — Comment on vole une voiture récente sans casser une vitre
...
```
Same object as the reference image, unchanged in geometry, proportions, materials and colour code. macro statique à hauteur de rétroviseur, faible profondeur de champ le rétroviseur sur la moitié gauche, la poignée en bas à droite Show: des impulsions rouges longent la carrosserie et atteignent le rétroviseur Keep the reference lighting and art direction.
```
...
```
Same object as the reference image, unchanged in geometry, proportions, materials and colour code. moyen statique à hauteur de volant, faible profondeur de champ le mannequin à gauche, la jante au centre, la route à droite Show: des impulsions vertes circulent dans la colonne pendant que la jante tourne Keep the reference lighting and art direction.
```
