...
- **Limite connue** : la vérification est côté client uniquement pour l'instant — les fonctions SQL des fonctionnalités IA ne vérifient pas encore l'abonnement ni le quota elles-mêmes. Suffisant pour une V1 sans utilisateurs adverses, mais une vraie protection des revenus demandera d'ajouter ce contrôle aussi côté serveur (voir "Pas encore fait" ci-dessous).
